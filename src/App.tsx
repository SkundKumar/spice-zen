...
function App() {
  ...
  <div className="h-10 w-52 rounded-full bg-orange-500 flex justify-center items-center md:h-16 md:mt-10 transition duration-300 ease-in-out hover:bg-orange-600 hover:scale-105">
